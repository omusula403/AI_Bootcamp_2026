...
1. Clone this repository:
   ```bash
   git clone https://github.com/omusula403/AI_Bootcamp_2026.git
   cd AI_Bootcamp_2026

2. Run the program:
   ```bash
   python 1week_1_1_assignment.py
   ```
...
```
--- FINAL REPORT ---
student_ID: S001 | Name: Gesy | Average: 68.68 | Letter Grade: C | Passed: True
student_ID: S002 | Name: dike | Average: 71.67 | Letter Grade: B | Passed: True
```
...
```
AI_Bootcamp_2026/
├── 1week_1_1_assignment.py   # Main program file
└── README.md                 # This file
```
...
- **Functions**: `calculate_average()`, `assign_letter_grade()`, `class_report()`, plus input-validation helpers
- **Control structures**: if-elif-else, for loops, while loops
- **Error handling**: try/except for invalid numeric input and empty grade lists
